...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='vizzotop.conf'
CONFIGFOLDER='/root/.vizzotop'
COIN_DAEMON='vizzotopd'
COIN_CLI='vizzotopd'
COIN_PATH='/usr/local/bin/'
COIN_REPO='https://github.com/VizzoTopCore/vizzotop.git'
COIN_TGZ='https://github.com/VizzoTopCore/vizzotop/releases/download/1.0.4-lin/vizzotopd'
